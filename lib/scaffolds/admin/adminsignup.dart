                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          String outPut;
                                               ...
                                               outPut = await authenticationMethods.signUpAdmin(name:widget.name!.text, phone:widget.phone!.text, email:widget.email!.text,password:widget.password!.text);
                                               print("${outPut} '''''''''''''''''''''''''''''''''''''''''''''''''''''''");
                                               if(outPut =='success')
                                                 {
                                                   Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminDetails()));
                                                 }
